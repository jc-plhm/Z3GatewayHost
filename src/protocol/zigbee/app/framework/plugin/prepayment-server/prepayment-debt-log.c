                                                        ...
                                                        DebtPayload *debtPayload)
{
  ...
  for ( i = 0; i < NumDebtPayloads; i++ ) {
    (void) emberAfPutInt32uInResp(debtPayload[i].collectionTime);
    (void) emberAfPutInt32uInResp(debtPayload[i].amountCollected);
    (void) emberAfPutInt8uInResp(debtPayload[i].debtType);
    (void) emberAfPutInt32uInResp(debtPayload[i].outstandingDebt);
  }

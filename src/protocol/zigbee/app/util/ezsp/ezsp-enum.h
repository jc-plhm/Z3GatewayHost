...
enum {
  ...
  // Sets the mask that controls which pins will have their GPIO configuration
  // and output values set to their power-up and power-down values when the NCP
  // powers the radio up and down.
...
// Configuration Frames
  ...
  EZSP_SET_GPIO_CURRENT_CONFIGURATION           = 0x00AC,
  EZSP_SET_GPIO_POWER_UP_DOWN_CONFIGURATION     = 0x00AD,

...
class RM_Peripheral_AGC(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.FLARE = RM_Register_AGC_FLARE(self.zz_rmio, self.zz_label)
        self.zz_rdict['FLARE'] = self.FLARE
        self.STEPDWNSAFE = RM_Register_AGC_STEPDWNSAFE(self.zz_rmio, self.zz_label)
        self.zz_rdict['STEPDWNSAFE'] = self.STEPDWNSAFE
        self.COLLDETCTRL = RM_Register_AGC_COLLDETCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['COLLDETCTRL'] = self.COLLDETCTRL
        self.COLLDETTHD = RM_Register_AGC_COLLDETTHD(self.zz_rmio, self.zz_label)
        self.zz_rdict['COLLDETTHD'] = self.COLLDETTHD
        self.COLLDETSTATUS = RM_Register_AGC_COLLDETSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['COLLDETSTATUS'] = self.COLLDETSTATUS
        self.SETTLINGINDCTRL = RM_Register_AGC_SETTLINGINDCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['SETTLINGINDCTRL'] = self.SETTLINGINDCTRL
        self.SETTLINGINDPER = RM_Register_AGC_SETTLINGINDPER(self.zz_rmio, self.zz_label)
        self.zz_rdict['SETTLINGINDPER'] = self.SETTLINGINDPER
        self.SMFIF = RM_Register_AGC_SMFIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['SMFIF'] = self.SMFIF
        self.SFMIEN = RM_Register_AGC_SFMIEN(self.zz_rmio, self.zz_label)

...
class RM_Peripheral_RAC(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.FEMCTRL = RM_Register_RAC_FEMCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['FEMCTRL'] = self.FEMCTRL
        self.FEMDATA = RM_Register_RAC_FEMDATA(self.zz_rmio, self.zz_label)
        ...
        self.PADEBUG0 = RM_Register_RAC_PADEBUG0(self.zz_rmio, self.zz_label)
        ...
        self.SYDIVCTRL = RM_Register_RAC_SYDIVCTRL(self.zz_rmio, self.zz_label)
        ...
        self.TXOGNDPKD = RM_Register_RAC_TXOGNDPKD(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXOGNDPKD'] = self.TXOGNDPKD
        self.TXOGNDPKDSTATUS = RM_Register_RAC_TXOGNDPKDSTATUS(self.zz_rmio, self.zz_label)
        ...
        self.GPPLLCLKRETIMECTRL = RM_Register_RAC_GPPLLCLKRETIMECTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['GPPLLCLKRETIMECTRL'] = self.GPPLLCLKRETIMECTRL
        self.GPPLLCLKRETIMESTATUS = RM_Register_RAC_GPPLLCLKRETIMESTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['GPPLLCLKRETIMESTATUS'] = self.GPPLLCLKRETIMESTATUS
        self.PATRIM6 = RM_Register_RAC_PATRIM6(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM6'] = self.PATRIM6
        self.PATRIM7 = RM_Register_RAC_PATRIM7(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM7'] = self.PATRIM7
        self.PATRIM8 = RM_Register_RAC_PATRIM8(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM8'] = self.PATRIM8
        self.PATRIM9 = RM_Register_RAC_PATRIM9(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM9'] = self.PATRIM9
        self.PATRIM10 = RM_Register_RAC_PATRIM10(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM10'] = self.PATRIM10
        self.TXRFPKD = RM_Register_RAC_TXRFPKD(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXRFPKD'] = self.TXRFPKD
        self.TXSTATUS = RM_Register_RAC_TXSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXSTATUS'] = self.TXSTATUS
        self.TXOFDM = RM_Register_RAC_TXOFDM(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXOFDM'] = self.TXOFDM
        self.TXMIX = RM_Register_RAC_TXMIX(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXMIX'] = self.TXMIX
        self.TXITC = RM_Register_RAC_TXITC(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXITC'] = self.TXITC
        self.TXCALITC = RM_Register_RAC_TXCALITC(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXCALITC'] = self.TXCALITC
        self.SPACER = RM_Register_RAC_SPACER(self.zz_rmio, self.zz_label)
        self.zz_rdict['SPACER'] = self.SPACER
        self.TXPKDCTRL = RM_Register_RAC_TXPKDCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXPKDCTRL'] = self.TXPKDCTRL
        self.TXPKDCMD = RM_Register_RAC_TXPKDCMD(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXPKDCMD'] = self.TXPKDCMD
        self.TXPKDSTATUS = RM_Register_RAC_TXPKDSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXPKDSTATUS'] = self.TXPKDSTATUS
        self.RADIOCLKCTRL = RM_Register_RAC_RADIOCLKCTRL(self.zz_rmio, self.zz_label)
        ...
        self.SOFTMCTRL = RM_Register_RAC_SOFTMCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['SOFTMCTRL'] = self.SOFTMCTRL
        self.SFMIF = RM_Register_RAC_SFMIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['SFMIF'] = self.SFMIF
        self.SFMIEN = RM_Register_RAC_SFMIEN(self.zz_rmio, self.zz_label)

...
class RM_Peripheral_MODEM(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.OOKSHAPING = RM_Register_MODEM_OOKSHAPING(self.zz_rmio, self.zz_label)
        ...
        self.ANARAMP0 = RM_Register_MODEM_ANARAMP0(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP0'] = self.ANARAMP0
        self.ANARAMP1 = RM_Register_MODEM_ANARAMP1(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP1'] = self.ANARAMP1
        self.ANARAMP2 = RM_Register_MODEM_ANARAMP2(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP2'] = self.ANARAMP2
        self.ANARAMP3 = RM_Register_MODEM_ANARAMP3(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP3'] = self.ANARAMP3
        self.ANARAMP4 = RM_Register_MODEM_ANARAMP4(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP4'] = self.ANARAMP4
        self.ANARAMP5 = RM_Register_MODEM_ANARAMP5(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP5'] = self.ANARAMP5
        self.ANARAMP6 = RM_Register_MODEM_ANARAMP6(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP6'] = self.ANARAMP6
        self.ANARAMP7 = RM_Register_MODEM_ANARAMP7(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP7'] = self.ANARAMP7
        self.ANARAMP8 = RM_Register_MODEM_ANARAMP8(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP8'] = self.ANARAMP8
        self.ANARAMP9 = RM_Register_MODEM_ANARAMP9(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANARAMP9'] = self.ANARAMP9
        self.ANARAMP10 = RM_Register_MODEM_ANARAMP10(self.zz_rmio, self.zz_label)
        ...
        self.BCRCTRL0 = RM_Register_MODEM_BCRCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRCTRL0'] = self.BCRCTRL0
        self.BCRCTRL1 = RM_Register_MODEM_BCRCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRCTRL1'] = self.BCRCTRL1
        self.BCRDEMODCTRL = RM_Register_MODEM_BCRDEMODCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODCTRL'] = self.BCRDEMODCTRL
        self.BCRDEMODOOK = RM_Register_MODEM_BCRDEMODOOK(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODOOK'] = self.BCRDEMODOOK
        self.BCRDEMODAFC0 = RM_Register_MODEM_BCRDEMODAFC0(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODAFC0'] = self.BCRDEMODAFC0
        self.BCRDEMODAFC1 = RM_Register_MODEM_BCRDEMODAFC1(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODAFC1'] = self.BCRDEMODAFC1
        self.BCRDEMOD4FSK0 = RM_Register_MODEM_BCRDEMOD4FSK0(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMOD4FSK0'] = self.BCRDEMOD4FSK0
        self.BCRDEMOD4FSK1 = RM_Register_MODEM_BCRDEMOD4FSK1(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMOD4FSK1'] = self.BCRDEMOD4FSK1
        self.BCRDEMODANT = RM_Register_MODEM_BCRDEMODANT(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODANT'] = self.BCRDEMODANT
        self.BCRDEMODRSSI = RM_Register_MODEM_BCRDEMODRSSI(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODRSSI'] = self.BCRDEMODRSSI
        self.BCRDEMODARR0 = RM_Register_MODEM_BCRDEMODARR0(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODARR0'] = self.BCRDEMODARR0
        self.BCRDEMODARR1 = RM_Register_MODEM_BCRDEMODARR1(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODARR1'] = self.BCRDEMODARR1
        self.BCRDEMODARR2 = RM_Register_MODEM_BCRDEMODARR2(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODARR2'] = self.BCRDEMODARR2
        self.BCRDEMODKSI = RM_Register_MODEM_BCRDEMODKSI(self.zz_rmio, self.zz_label)
        self.zz_rdict['BCRDEMODKSI'] = self.BCRDEMODKSI
        self.BCRDEMODPMEXP = RM_Register_MODEM_BCRDEMODPMEXP(self.zz_rmio, self.zz_label)

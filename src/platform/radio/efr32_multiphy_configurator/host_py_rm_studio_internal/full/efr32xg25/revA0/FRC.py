...
class RM_Peripheral_FRC(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.OTACNT = RM_Register_FRC_OTACNT(self.zz_rmio, self.zz_label)
        ...
        self.AUTOCG = RM_Register_FRC_AUTOCG(self.zz_rmio, self.zz_label)
        self.zz_rdict['AUTOCG'] = self.AUTOCG
        self.CGCLKSTOP = RM_Register_FRC_CGCLKSTOP(self.zz_rmio, self.zz_label)
        self.zz_rdict['CGCLKSTOP'] = self.CGCLKSTOP
        self.SEQIF = RM_Register_FRC_SEQIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['SEQIF'] = self.SEQIF
        self.SEQIEN = RM_Register_FRC_SEQIEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['SEQIEN'] = self.SEQIEN
        self.WCNTCMP3 = RM_Register_FRC_WCNTCMP3(self.zz_rmio, self.zz_label)
        self.zz_rdict['WCNTCMP3'] = self.WCNTCMP3
        self.BOICTRL = RM_Register_FRC_BOICTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['BOICTRL'] = self.BOICTRL
        self.DSLCTRL = RM_Register_FRC_DSLCTRL(self.zz_rmio, self.zz_label)
        ...
        self.PKTBUF0 = RM_Register_FRC_PKTBUF0(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF0'] = self.PKTBUF0
        self.PKTBUF1 = RM_Register_FRC_PKTBUF1(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF1'] = self.PKTBUF1
        self.PKTBUF2 = RM_Register_FRC_PKTBUF2(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF2'] = self.PKTBUF2
        self.PKTBUF3 = RM_Register_FRC_PKTBUF3(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF3'] = self.PKTBUF3
        self.PKTBUF4 = RM_Register_FRC_PKTBUF4(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF4'] = self.PKTBUF4
        self.PKTBUF5 = RM_Register_FRC_PKTBUF5(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF5'] = self.PKTBUF5
        self.PKTBUF6 = RM_Register_FRC_PKTBUF6(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF6'] = self.PKTBUF6
        self.PKTBUF7 = RM_Register_FRC_PKTBUF7(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF7'] = self.PKTBUF7
        self.PKTBUF8 = RM_Register_FRC_PKTBUF8(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF8'] = self.PKTBUF8
        self.PKTBUF9 = RM_Register_FRC_PKTBUF9(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF9'] = self.PKTBUF9
        self.PKTBUF10 = RM_Register_FRC_PKTBUF10(self.zz_rmio, self.zz_label)
        self.zz_rdict['PKTBUF10'] = self.PKTBUF10
        self.PKTBUF11 = RM_Register_FRC_PKTBUF11(self.zz_rmio, self.zz_label)
        ...
        self.SPARE = RM_Register_FRC_SPARE(self.zz_rmio, self.zz_label)

...
class Profile_WiSUN_OFDM_Sol(IProfile):
    ...
    def build_variable_profile_outputs(self, model, profile):
        ...
        sw_profile_outputs_common_sol().build_ircal_outputs(model, profile)
    ...
    def _fixed_wisun_ofdm_agc(self, model):
        ...
        if model.profile.inputs.ofdm_option.var_value == model.vars.ofdm_option.var_enum.OPT1 or \
                model.profile.inputs.ofdm_option.var_value == model.vars.ofdm_option.var_enum.OPT2:

...
class Target_Sim_Sol(ITarget):
    ...
    def _softmodem_do_not_care(self, model):
        ...
        model.vars.SUNOFDM_SUNOFDMCFG_MODULATION.value_do_not_care = True
        model.vars.SUNOFDM_SUNOFDMCFG_OFDMOPTION.value_do_not_care = True
        model.vars.SUNOFDM_SUNOFDMCFG_INTERLEAVING.value_do_not_care = True
        model.vars.SUNOFDM_SUNOFDMCFG_MACFCSTYPE.value_do_not_care = True
        model.vars.SUNOFDM_SUNOFDMCFG_XTAL_FREQ.value_do_not_care = True
        model.vars.SUNOQPSK_SUNOQPSKCFG1_MODULATION.value_do_not_care = True
        model.vars.SUNOQPSK_SUNOQPSKCFG1_CHIPRATE.value_do_not_care = True
        model.vars.SUNOQPSK_SUNOQPSKCFG1_BANDFREQMHZ.value_do_not_care = True
        model.vars.SUNOQPSK_SUNOQPSKCFG2_MACFCSTYPE.value_do_not_care = True
        model.vars.SUNOQPSK_SUNOQPSKCFG2_XTAL_FREQ.value_do_not_care = True

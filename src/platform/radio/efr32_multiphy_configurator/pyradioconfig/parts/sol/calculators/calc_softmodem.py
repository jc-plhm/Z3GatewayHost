...
class calc_softmodem_sol(ICalculator):
    ...
    def calc_softmodem_cw(self, model):
        ...
        #Write the registers
        self._reg_write(model.vars.CW_CWCFG1_MODULATION, int(modulation_field), do_not_care=do_not_care)
        self._reg_write(model.vars.CW_CWCFG1_DUAL_PATH, int(dual_path_field), do_not_care=do_not_care)
        self._reg_write(model.vars.CW_CWCFG1_SIG_TYPE, int(sig_type_field), do_not_care=do_not_care)
        self._reg_write(model.vars.CW_CWCFG2_FREQ, int(freq_field), do_not_care=do_not_care)
        self._reg_write(model.vars.CW_CWCFG2_AMP, int(amp_field), do_not_care=do_not_care)
        self._reg_write(model.vars.CW_CWCFG3_XTAL_FREQ, int(xtal_freq_field), do_not_care=do_not_care)
    ...
    def calc_softmodem_sunofdm(self, model):
        ...
        #Write the registers
        self._reg_write(model.vars.SUNOFDM_SUNOFDMCFG_MODULATION, int(modulation_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOFDM_SUNOFDMCFG_OFDMOPTION, int(ofdmoption_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOFDM_SUNOFDMCFG_INTERLEAVING, int(interleaving_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOFDM_SUNOFDMCFG_MACFCSTYPE, int(macfcstype_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOFDM_SUNOFDMCFG_XTAL_FREQ, int(xtal_freq_field), do_not_care=do_not_care)
    ...
    def calc_softmodem_sunoqpsk(self, model):
        ...
        #Write the registers
        self._reg_write(model.vars.SUNOQPSK_SUNOQPSKCFG1_MODULATION, int(modulation_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOQPSK_SUNOQPSKCFG1_CHIPRATE, int(chiprate_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOQPSK_SUNOQPSKCFG1_BANDFREQMHZ, int(bandfreqmhz_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOQPSK_SUNOQPSKCFG2_MACFCSTYPE, int(macfcstype_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNOQPSK_SUNOQPSKCFG2_XTAL_FREQ, int(xtal_freq_field), do_not_care=do_not_care)
    ...
    def calc_softmodem_legoqpsk(self, model):
        ...
        # Write the registers
        self._reg_write(model.vars.LEGOQPSK_LEGOQPSKCFG1_MODULATION, int(modulation_field), do_not_care=do_not_care)
        self._reg_write(model.vars.LEGOQPSK_LEGOQPSKCFG1_CHIPRATE, int(chiprate_field), do_not_care=do_not_care)
        self._reg_write(model.vars.LEGOQPSK_LEGOQPSKCFG1_BANDFREQMHZ, int(bandfreqmhz_field), do_not_care=do_not_care)
        self._reg_write(model.vars.LEGOQPSK_LEGOQPSKCFG2_XTAL_FREQ, int(xtal_freq_field), do_not_care=do_not_care)
    ...
    def calc_softmodem_sunfsk(self, model):
        ...
        if softmodem_modulation_type == model.vars.softmodem_modulation_type.var_enum.SUN_FSK:
            ...
            fskpreamblelength_field = 0 #int(preamble_length // 8) #This field is denoted in bytes
        ...
        # Write the registers
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_MODULATION, int(modulation_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_FECSEL, int(fecsel_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_PHYSUNFSKSFD, int(physunfsksfd_field), do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_FSKPREAMBLELENGTH, fskpreamblelength_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_MODSCHEME, modscheme_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_BT, bt_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG1_MODINDEX, modindex_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG3_OSR, osr_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG2_VEQEN, veqen_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG2_KSI1, ksi1_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG2_KSI2, ksi2_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG2_KSI3, ksi3_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG3_KSI3W, ksi3w_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG3_PHASESCALE, phasescale_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG4_PREAMBLECOSTTHD, preamblecostthd_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG4_PREAMBLECNTWIN, preamblecntwin_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG4_PREAMBLECNTTHD, preamblecntthd_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG5_PREAMBLELEN, preamblelen_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG5_PREAMBLEERRORS, preambleerrors_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG5_PREAMBLETIMEOUT, preambletimeout_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG6_PREAMBLEPATT, preamblepatt_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG7_PREAMBLEFREQLIM, preamblefreqlim_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG7_PREAMBLECOSTMAX, preamblecostmax_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG8_SFD1, sfd1_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG9_SFD2, sfd2_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG10_SFDLEN, sfdlen_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG10_SFDCOSTTHD, sfdcostthd_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG11_SFDTIMEOUT, sfdtimeout_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG11_SFDERRORS, sfderrors_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG11_TIMTRACKGEAR, timtrackgear_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG12_TIMTRACKSYMB, timtracksymb_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG12_TIMMINTRANS, timmintrans_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG12_REALTIMESEARCH, realtimesearch_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG12_NBSYMBBATCH, nsymbbatch_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG13_CHFILTSWEN, chfiltswen_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG13_AFCMODE, afcmode_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG13_AFCSCALE, afcscale_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG14_AFCADJLIM, afcadjlim_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG15_AFCADJPERIOD, afcadjperiod_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG15_AFCCOSTTHD, afccostthd_field, do_not_care=do_not_care)
        self._reg_write(model.vars.SUNFSK_SUNFSKCFG15_XTAL_FREQ, int(xtal_freq_field), do_not_care=do_not_care)
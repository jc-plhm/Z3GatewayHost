...
class PHYS_IEEE802154_WiSUN_FSK_Sol(PHYS_IEEE802154_WiSUN_Ocelot):
    ...
    # Owner: Casey Weltzin
    # Jira Link: https://jira.silabs.com/browse/PGSOLVALTEST-84
    def PHY_IEEE802154_WISUN_868MHz_2GFSK_300kbps_5_SG(self, model, phy_name=None):
        phy = self._makePhy(model, model.profiles.WiSUN_FSK, readable_name='Wi-SUN FAN, SG-868MHz, 5 (2GFSK 300kbps mi=0.5)', phy_name=phy_name)
        ...
        # Define WiSUN Profile / Region specific inputs
        phy.profile_inputs.base_frequency_hz.value = 866300000
        phy.profile_inputs.channel_spacing_hz.value = 400000
        phy.profile_inputs.preamble_length.value = 24 * 8
        phy.profile_inputs.fcs_type_802154.value = model.vars.fcs_type_802154.var_enum.FOUR_BYTE

...
def build_modem_regs_sol_only(model, profile, family):
    ...
    profile.outputs.append(ModelOutput(model.vars.RAC_SCRATCH6_SCRATCH6, '',         ModelOutputType.SVD_REG_FIELD, readable_name='RAC.SCRATCH6.SCRATCH6'           )) 
    ...
    profile.outputs.append(ModelOutput(model.vars.FRC_RXCTRL_IFINPUTWIDTH, '',         ModelOutputType.SVD_REG_FIELD, readable_name='FRC.RXCTRL.IFINPUTWIDTH'           ))
    ...
    #CW Peripheral
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG1_MODULATION, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG1.MODULATION'))
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG1_DUAL_PATH, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG1.DUAL_PATH'))
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG1_SIG_TYPE, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG1.SIG_TYPE'))
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG2_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG2.FREQ'))
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG2_AMP, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG2.AMP'))
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG3_XTAL_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG3.XTAL_FREQ'))

    #SUNOFDM Peripheral
    profile.outputs.append(ModelOutput(model.vars.SUNOFDM_SUNOFDMCFG_MODULATION, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOFDM.SUNOFDMCFG.MODULATION'))
    profile.outputs.append(ModelOutput(model.vars.SUNOFDM_SUNOFDMCFG_OFDMOPTION, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOFDM.SUNOFDMCFG.OFDMOPTION'))
    profile.outputs.append(ModelOutput(model.vars.SUNOFDM_SUNOFDMCFG_INTERLEAVING, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOFDM.SUNOFDMCFG.INTERLEAVING'))
    profile.outputs.append(ModelOutput(model.vars.SUNOFDM_SUNOFDMCFG_MACFCSTYPE, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOFDM.SUNOFDMCFG.MACFCSTYPE'))
    profile.outputs.append(ModelOutput(model.vars.SUNOFDM_SUNOFDMCFG_XTAL_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOFDM.SUNOFDMCFG.XTAL_FREQ'))

    #SUNOQPSK Peripheral
    profile.outputs.append(ModelOutput(model.vars.SUNOQPSK_SUNOQPSKCFG1_MODULATION, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOQPSK.SUNOQPSKCFG1.MODULATION'))
    profile.outputs.append(ModelOutput(model.vars.SUNOQPSK_SUNOQPSKCFG1_CHIPRATE, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOQPSK.SUNOQPSKCFG1.CHIPRATE'))
    profile.outputs.append(ModelOutput(model.vars.SUNOQPSK_SUNOQPSKCFG1_BANDFREQMHZ, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOQPSK.SUNOQPSKCFG1.BANDFREQMHZ'))
    profile.outputs.append(ModelOutput(model.vars.SUNOQPSK_SUNOQPSKCFG2_MACFCSTYPE, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOQPSK.SUNOQPSKCFG2.MACFCSTYPE'))
    profile.outputs.append(ModelOutput(model.vars.SUNOQPSK_SUNOQPSKCFG2_XTAL_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNOQPSK.SUNOQPSKCFG2.XTAL_FREQ'))

    #LEGOQPSK Peripheral
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG1_MODULATION, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG1.MODULATION'))
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG1_CHIPRATE, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG1.CHIPRATE'))
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG1_BANDFREQMHZ, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG1.BANDFREQMHZ'))
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG2_XTAL_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG2.XTAL_FREQ'))

    #SUNFSK Peripheral
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_MODULATION, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.MODULATION'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_FECSEL, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.FECSEL'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_PHYSUNFSKSFD, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.PHYSUNFSKSFD'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_FSKPREAMBLELENGTH, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.FSKPREAMBLELENGTH'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_MODSCHEME, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.MODSCHEME'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_BT, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.BT'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_MODINDEX, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.MODINDEX'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG3_OSR, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG3.OSR'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG2_VEQEN, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG2.VEQEN'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG2_KSI1, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG2.KSI1'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG2_KSI2, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG2.KSI2'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG2_KSI3, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG2.KSI3'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG3_KSI3W, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG3.KSI3W'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG3_PHASESCALE, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG3.PHASESCALE'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG4_PREAMBLECOSTTHD, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG4.PREAMBLECOSTTHD'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG4_PREAMBLECNTWIN, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG4.PREAMBLECNTWIN'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG4_PREAMBLECNTTHD, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG4.PREAMBLECNTTHD'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG5_PREAMBLELEN, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG5.PREAMBLELEN'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG5_PREAMBLEERRORS, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG5.PREAMBLEERRORS'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG5_PREAMBLETIMEOUT, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG5.PREAMBLETIMEOUT'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG6_PREAMBLEPATT, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG6.PREAMBLEPATT'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG7_PREAMBLEFREQLIM, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG7.PREAMBLEFREQLIM'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG7_PREAMBLECOSTMAX, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG7.PREAMBLECOSTMAX'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG8_SFD1, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG8.SFD1'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG9_SFD2, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG9.SFD2'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG10_SFDLEN, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG10.SFDLEN'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG10_SFDCOSTTHD, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG10.SFDCOSTTHD'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG11_SFDTIMEOUT, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG11.SFDTIMEOUT'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG11_SFDERRORS, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG11.SFDERRORS'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG11_TIMTRACKGEAR, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG11.TIMTRACKGEAR'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG12_TIMTRACKSYMB, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG12.TIMTRACKSYMB'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG12_TIMMINTRANS, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG12.TIMMINTRANS'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG12_REALTIMESEARCH, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG12.REALTIMESEARCH'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG12_NBSYMBBATCH, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG12.NBSYMBBATCH'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG13_CHFILTSWEN, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG13.CHFILTSWEN'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG13_AFCMODE, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG13.AFCMODE'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG13_AFCSCALE, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG13.AFCSCALE'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG14_AFCADJLIM, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG14.AFCADJLIM'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG15_AFCADJPERIOD, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG15.AFCADJPERIOD'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG15_AFCCOSTTHD, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG15.AFCCOSTTHD'))
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG15_XTAL_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG15.XTAL_FREQ'))